export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx75fe70e3e7ed51cf",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5167e282548a214682a999376953033e",
  ...
  USERS: [
    {
      ...
      id: "ogNcm6IODx9QAA89uJ9oZM2N0LaE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "J_ywKKWzFyLKBImhwGXSE5n4xq4IGZckAHAHl5aWaQU",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "珠海",
